...
function promptUser() {
    inquirer
      .prompt([
        ...
        {
          type: "input",
          message: "What text would you like to display inside your logo? (Enter up to three characters)",
          name: "text",
        },
        // Text color prompt
        {
        ...
        // Shape color prompt
        {
          type: "input",
          message:
            "What color would you like your shape to render (Enter color keyword OR a hexadecimal number)",
